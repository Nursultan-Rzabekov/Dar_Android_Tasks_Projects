package com.example.cleanarhitecturewithmvvm.mvvm.adapters
...
class MyRecyclerTestViewAdapter (private val languageList : ArrayList<Language>, private val listener : Listener)
    : RecyclerView.Adapter<MyRecyclerTestViewAdapter.ViewHolder>() {
