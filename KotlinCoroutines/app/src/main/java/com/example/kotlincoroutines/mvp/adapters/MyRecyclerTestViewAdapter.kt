package com.example.kotlincoroutines.mvp.adapters
...
class MyRecyclerTestViewAdapter (private val languageList : ArrayList<LanguageRoomDB>, private val listener : Listener) : RecyclerView.Adapter<MyRecyclerTestViewAdapter.ViewHolder>() {

    interface Listener {
        fun onItemClick(language: LanguageRoomDB, position: Int)
    }
    ...
    class ViewHolder(view : View) : RecyclerView.ViewHolder(view) {
        fun bind(language:LanguageRoomDB, listener: Listener, colors : Array<String>, position: Int) {
